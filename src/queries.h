...
class Queries {
 public:
  ...
  Query *GetQuery(uint32_t id) { return queries_[id].get(); }
  size_t GetNumberOfSequences() { return queries_.size(); }

  uint32_t GetMaxQuerySequenceLength() { return max_query_sequence_length_; }
