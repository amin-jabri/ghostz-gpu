...
class UngappedExtenderGpu {
 public:
  ...
  int ExtendWithTriggerAsync(size_t size, uint32_t* query_ids,
                             ...
                             uint32_t* database_positions, char* flags,
                             uint32_t* d_query_ids,
                             uint32_t* d_query_concatenated_positions,
  ...
  int ExtendWithTriggerAsync(
      ...
      uint32_t* query_seed_starts, size_t size, uint32_t* query_ids,
      uint32_t* query_concatenated_positions, uint32_t* database_positions,
      int* scores, uint32_t* d_query_seed_ids, uint32_t* d_query_seed_starts,
      size_t temp_storage_bytes, void* d_temp_storage, uint32_t* d_query_ids,
