...
class GappedExtender {
 public:
  ...
  bool ExtendOneSide(const AlphabetCoder::Code *sequence0,
                     uint32_t sequence0_length,
                     const AlphabetCoder::Code *sequence1,
                     const AlphabetCoder::Code sequence_delimiter,
                     bool reversed, const ScoreMatrix &score_matrix,
 ...
 private:
  ...
  bool ExtendOneSideScoreOnly(const AlphabetCoder::Code *sequence0,
                              uint32_t sequence0_length,
                              const AlphabetCoder::Code *sequence1,
                              const AlphabetCoder::Code sequence_delimiter,
                              bool reversed, const ScoreMatrix &score_matrix,
  ...
  void PickOptimalPath(const std::vector<uint8_t *> &edit_script,
                       const std::vector<uint32_t> &edit_script_offset,
                       int query_position, int db_position, int increment,
