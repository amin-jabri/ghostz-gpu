...
class AlphabetCoder {
 public:
  ...
  Code GetMinRegularLetterCode() const { return min_regular_letter_code_; }

  Code GetMaxRegularLetterCode() const { return max_regular_letter_code_; }

  Code GetMinCode() const { return min_code_; }

  Code GetMaxCode() const { return max_code_; }

  Code GetUnknownCode() const { return unknown_code_; }
