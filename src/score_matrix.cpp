...
ScoreMatrix::ScoreMatrix(const std::string &name, uint32_t number_letters,
                         int match, int mismatch)
    : name_(name),
      matrix_(0),
      highest_value_(match),
      lowest_value_(mismatch),
...
ScoreMatrix::ScoreMatrix(const std::string &name, int *matrix,
    ...
    : name_(name),
      ...
      lowest_value_(0),
      number_letters_(number_letters) {
  matrix_.insert(matrix_.begin(), matrix,
                 matrix + number_letters * number_letters);
