...
class TranslatedDnaQuery : public Query {
 public:
  ...
  uint32_t GetRealSequenceLength() { return dna_length_ / 3; }
 ...
 protected:
  ...
  void SetEncodedSequence(const Sequence &sequence, const AlphabetCoder &coder,
                          Translator &translator,
                          SequenceFilterInterface *filter);
  void SetStaticalParameters(
      ScoreMatrix &score_matrix,
      Statistics::KarlinParameters &ungapped_ideal_karlin_parameters);
