...
int OneMismatchHashGenerator::GenerateOneMismatchHash(
    const Hash basic_hash, const uint32_t k_mer_length,
    const AlphabetCoder::Code max_code, const uint32_t bit_shift_size,
    std::vector<Hash> *one_mismatch_hashs) {
