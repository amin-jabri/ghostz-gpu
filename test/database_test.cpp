 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    const string default_protein_matrix =
        ...
        "-2  1  0 -3 -1  0 -1 -2 -1 -2  0  3 -1 -4\n E -1  0  0  2 -4  2  5 -2 "
        " 0 -3 -3  1 -2 -3 -1  0 -1 -3 -2 -2  1  4 -1 -4\n G  0 -2  0 -1 -3 -2 "
        "-2  6 -2 -4 -4 -2 -3 -3 -2  0 -2 -2 -3 -3 -1 -2 -1 -4\n H -2  0  1 -1 "
        "-3  0  0 -2  8 -3 -3 -1 -2 -1 -2 -1 -2 -2  2 -3  0  0 -1 -4\n I -1 -3 "
        "-3 -3 -1 -3 -3 -4 -3  4  2 -3  1  0 -3 -2 -1 -3 -1  3 -3 -3 -1 -4\n L "
        ...
        "-2 -1  4  1 -3 -2 -2  0  0  0 -4\n T  0 -1  0 -1 -1 -1 -1 -2 -2 -1 -1 "
        "-1 -1 -2 -1  1  5 -2 -2  0 -1 -1  0 -4\n W -3 -3 -4 -4 -2 -2 -3 -2 -2 "
        "-3 -2 -3 -1  1 -4 -3 -2 11  2 -3 -4 -3 -2 -4\n Y -2 -2 -2 -3 -2 -1 -2 "
        "-3  2 -1 -1 -2 -1  3 -3 -2 -2  2  7 -1 -3 -2 -1 -4\n V  0 -3 -3 -3 -1 "
        "-2 -2 -3 -3  3  1 -2  1 -1 -2 -2  0 -3 -1  4 -3 -2 -1 -4\n B -2 -1  3 "
        " 4 -3  0  1 -1  0 -3 -4  0 -3 -3 -2  0 -1 -4 -3 -3  4  1 -1 -4\n Z -1 "
        " 0  0  1 -3  3  4 -2  0 -3 -3  1 -1 -3 -1  0 -1 -3 -2 -2  1  4 -1 "
    ...
    parameters.seed_search_parameters_build_parameters.score_matrix =
        ScoreMatrix(default_protein_matrix_name, &matrix[0], number_letters);
    ...
    parameters.seed_search_parameters_build_parameters.subsequence_length = 0;
    ...
    parameters.seed_search_parameters_build_parameters.hash_code_map.resize(
        coder.GetMaxCode() + 1, reduced_alphabet_coder.GetUnknownCode());
    parameters.seed_search_parameters_build_parameters.similairty_code_map
        .resize(coder.GetMaxCode() + 1,
    ...
    for (AlphabetCoder::Code code = coder.GetMinCode(); code <= max_code;
      ...
      parameters.seed_search_parameters_build_parameters.hash_code_map[code] =
          reduced_code;
      parameters.seed_search_parameters_build_parameters
          .similairty_code_map[code] = reduced_code;
    }
    parameters.seed_search_parameters_build_parameters.max_indexing_code =
        reduced_alphabet_coder.GetMaxRegularLetterCode();
    database_ =
        std::tr1::shared_ptr<DatabaseType>(new DatabaseType(in_, parameters));
  }

  virtual void TearDown() { in_.close(); }
  ifstream in_;
